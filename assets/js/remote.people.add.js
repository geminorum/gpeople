...
jQuery(function ($) {
  ...
  // var gPeopleUsers = [];
  // var gPeopleUsersPaged = 0;

  var gPeopleChangeTab = function (active) {
  ...
  $('#the-list').on('click', 'a.editinline', function (event) {
    ...
    var firstname = $('td.people-extra span.firstname', '#' + tag).attr('data-firstname');
    var lastname = $('td.people-extra span.lastname', '#' + tag).attr('data-lastname');
    var altname = $('td.people-extra span.altname', '#' + tag).attr('data-altname');
